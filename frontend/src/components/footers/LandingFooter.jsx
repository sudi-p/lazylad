  ...
  render(){
    return(
      <ul>
        ...
        <li><NavLink to="/">Service Areas</NavLink></li>
        <li><NavLink to="/">Contect Support</NavLink></li>
  ...
  render(){
    return( 
      <ul>
        ...
        <li><NavLink to="/">Our Resturants</NavLink></li>
        <li><NavLink to="/">Our Cooks</NavLink></li>
      </ul>
    );
  }
}
...
class Services extends Component{
  render(){
    return(
      <ul>
        <li><NavLink to="/">Order Foods</NavLink></li>
        <li><NavLink to="/">Hire A Cook</NavLink></li>
      </ul>
    );
  }
}
    ...
    return(
      <div>
        <div className="social">
          <NavLink to="/"><Icon className="social_icon" type="facebook" /></NavLink>
          <NavLink to="/"><Icon className="social_icon" type="twitter" /></NavLink>
          <NavLink to="/"><Icon className="social_icon" type="youtube" /></NavLink>
          <NavLink to="/"><Icon className="social_icon" type="google" /></NavLink>
        </div>
      </div>
    );
  }
    ...
    return(
      <footer className="footer">
        ...
        <div className="footer--small">
          <div onClick={this.helpStyle.bind(this)} className="footer__title">Help<Icon type="down" /></div>
          <div style={help_style}>
            <Help />
          </div>
          <div onClick={this.lazyladStyle.bind(this)} className="footer__title">LazyLad<Icon type="down" /></div>
          <div style={lazylad_style}>
            <LazyLad />
          </div>
          <div onClick={this.serviceStyle.bind(this)} className="footer__title">Services<Icon type="down" /></div>
