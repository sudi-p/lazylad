  ...
  render(){
    return(
      <div className="plans-view">
        <div className="plans-wrapper"><Plans planSelect={this.planSelect}/></div>
        <Review />
        <CommonQuestions />
      </div>
    );
    ...
    return(
      <div className="review">
        <div className="review-wrapper">
          ...
          dots="false">
            <div>
            “Thank you @redlentils, this was better than any restaurant I could've gone to!” — @WillSmith
            </div>
            <div>
              “Feel like a kid on Christmas morning when we get a delivery.” — @Christpher Nolan
            </div>
            <div>
              “This might actually be the best thing that’s ever happened to me.” — @Hugh Jackman
            </div>
            <div>
              “I'd marry @redlentils if I could. We just have a good thing goin’ on.” — @Ryan Reynolds
            </div>
          </Carousel>
        </div>
      </div>
