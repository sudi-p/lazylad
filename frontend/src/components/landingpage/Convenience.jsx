    ...
    return(
      <section className="convenience">
        <div className="section_header">
          <h1 className="section_header--primary"> Convenience you can count on. </h1>
          <h4 className="section_header--secondary"> Accuracy, innovation, excellence—we make your dining absolutely delicious. </h4>
        </div>
        <Row type="flex">
          <ConvenienceCard
            title="Slack orders"
      ...
      <Col
        ...
        <div className="item">
           ...
           <div className="item_text">
            <span className="item_text--primary">
              {this.props.title}
            </span>
